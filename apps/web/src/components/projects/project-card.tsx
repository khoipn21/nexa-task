...
const PROJECT_COLORS: Record<
  string,
  { border: string; dot: string; progress: string }
> = {
...
export function ProjectCard({ project }: { project: Project }) {
  ...
  const colors = PROJECT_COLORS[colorKey] || {
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Card contains block elements that can't be inside button
    <div
      role="button"
      tabIndex={0}
