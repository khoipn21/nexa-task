 ...
 */
export function TaskDetailContent({ taskId, statuses, members, projectId }: Props) {
    ...
    <div className="flex gap-8 items-start">
      ...
      <Stack className="flex-1 min-w-0" gap="xl">
        <TextInput
          ...
          size="xl"
          classNames={{
            input: "text-2xl font-bold bg-transparent p-0 m-0 h-auto focus:border-none focus:ring-0",
          }}
          placeholder="Task title"
        />

        <TaskEditor content={task.description || ""} onChange={handleDescriptionChange} />
